...
99 UX rules organized by priority. Load `references/quick-reference.md` for the complete rule set.
...
| 7 | Animation | MEDIUM | 150-300ms duration, Transform/opacity only |
...
For app-specific (iOS/Android/React Native/Flutter) professional UI rules, icon standards, interaction patterns, light/dark mode contrast, layout spacing, and the pre-delivery checklist, see `references/common-rules.md`.