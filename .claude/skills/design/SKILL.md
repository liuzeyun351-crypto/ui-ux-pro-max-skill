---
name: design
description: "Comprehensive design skill for brand identity, design tokens, UI styling, logo generation (55 styles, Gemini AI), corporate identity programs (50 deliverables, CIP mockups), HTML presentations (Chart.js), banner design (22 styles, social/ads/web/print), icon design (15 styles, SVG), and social photos. Use when the user asks to design logos, create CIP deliverables, generate mockups, build slides, design banners, generate icons, or create social media images. Platforms: Facebook, Twitter, LinkedIn, YouTube, Instagram, Pinterest, TikTok, Threads, Google Ads."
license: MIT
metadata:
  author: claudekit
  version: "2.1.0"
